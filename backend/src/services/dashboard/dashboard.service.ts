...
export class DashboardService {
   ...
   */
  async getDashboard(userId: string, tzOffset: number = 0) {
    ...
    let sumUv = 0;
    let lowUv: number | null = null;
    let lowTime: string | null = null;
    
    const hourlyAggregation: Record<string, number> = {};
    ...
    // Calculate burn time
    let burnTimeRemaining: number | null = null;
